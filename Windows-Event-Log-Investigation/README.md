...
```mermaid
flowchart TD
    classDef event fill:#e7f5ff,stroke:#1971c2,stroke-width:2px,color:#1864ab

    T1["11:16 — Successful Logon (4624)<br/>User authentication confirmed"]:::event
    T2["11:18 — Encoded PowerShell Execution<br/>Malicious payload launched"]:::event
    T3["11:21 — System Discovery (systeminfo)<br/>Reconnaissance phase"]:::event
    T4["11:21 — User Enumeration (net user)<br/>Account discovery"]:::event
    T5["11:21 — Task Enumeration (schtasks /query)<br/>Persistence reconnaissance"]:::event
    T6["11:21 — updates.bat Created<br/>Malicious batch file written to disk"]:::event
    T7["12:27 — Scheduled Task Set<br/>Daily 11:00 AM trigger configured"]:::event
    T8["12:29 — Ransomware Note Displayed<br/>Impact / end of simulation"]:::event
